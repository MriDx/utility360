...
class PendingMeterInstallationDataSource(private val getPendingMeterInstallationsUseCase: GetPendingMeterInstallationsUseCase) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, CustomerResource> =
        withContext(Dispatchers.IO) {
            ...
            try {
                ...
                val response = getPendingMeterInstallationsUseCase(query)
