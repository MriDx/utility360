...
class MeterReadingsTasksAdapter @Inject constructor() :
    PagingDataAdapter<CustomerResource, MeterReadingsTasksAdapter.MeterReadingTaskViewModel>(
    ...
    override fun onBindViewHolder(holder: MeterReadingTaskViewModel, position: Int) {
        holder.bind(getItem(position)!!)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MeterReadingTaskViewModel {
        return MeterReadingTaskViewModel(
    ...
    inner class MeterReadingTaskViewModel(private val binding: TaskViewBinding) :
